use crate::cache::parsed_source_cache::ParsedSourceCache;
use crate::cache::{CacheSetting, GlobalHttpCache};
use crate::loaders::file_fetcher::{FetchOptions, FileFetcher};
use crate::util::emit::EmitCache;
use crate::util::errors_rt::get_error_class_name;
use crate::util::fs::canonicalize_path_maybe_not_exists;
use crate::util::module_info::{ModuleInfoCache, ModuleInfoCacheSourceHash};
            ...
            file_fetcher
                ...
                .unwrap_or_else(|err| {
                    ...
                    match error_class_name {
                        Some("NotFound") => Ok(None),
                        Some("NotCached") if cache_setting == LoaderCacheSetting::Only => Ok(None),
                        _ => Err(err),
                    }
                })
        }
